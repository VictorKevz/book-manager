...
export const TopHeader = () => {
  ...
  return (
    <header className="w-full min-h-[5rem] fixed top-0 flex items-center justify-between px-5 bg-[var(--neutral-400)] border-b border-[var(--neutral-100)] z-50">
      ...
      <div className="h-[2.5rem] max-w-sm w-full bg-[var(--neutral-100)] text-[var(--neutral-900)] rounded-full">
